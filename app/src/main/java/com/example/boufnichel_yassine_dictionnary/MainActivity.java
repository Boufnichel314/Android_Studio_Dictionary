...
import com.example.boufnichel_yassine_dictionnary.Adapters.MeaningAdapter;
import com.example.boufnichel_yassine_dictionnary.Adapters.PhoneticsAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recycler_meanings = (RecyclerView) findViewById(R.id.recycler_meanings);
        recycler_phonetics = (RecyclerView)  findViewById(R.id.recycler_phonetics);
